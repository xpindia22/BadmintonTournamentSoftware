 ...
 <tr>
  ...
  <td>
   <select name='refsource'>
    ...
    //email code
    // Assume $result is the result of the patient save operation
if ($result) {
    // Patient data saved successfully, now we send the email
    $to = "xpindia@gmail.com";
    $subject = "New Patient Registration";
    $message = "A new patient has been registered: " . $form_fname . " " . $form_lname;
