...
if ($sale_id === null) {
    echo "<div id='message'>Medication Saved</div>"; // Handle the case when 'sale_id' is not set
}
...
try {
    $db = new PDO('mysql:host=localhost;dbname=open72;charset=utf8', 'open72', 'sL!L4rVT(kD46q8g');
