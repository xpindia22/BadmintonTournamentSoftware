...
?>
 ...
 <tr id='row_quantity'>
  ...
  <td>
   <input class="form-control" type='number' step='0.01' size='5' name='form_quantity' maxlength='7' />
  </td>
 </tr>
 ...
 <tr id='row_cost'>
  ...
  <td>
   <input class="form-control" type='number' step='0.01' size='7' name='form_cost' maxlength='12' />
  </td>
 </tr>

<tr id='price_one'>
  <td class="text-nowrap align-top"><?php echo xlt('Price Of One Tablet'); ?>:</td>
 
  <td>
   <input class="form-control" type='number' step='0.01' size='7' name='price_one' maxlength='12' />
  </td>
 </tr>
